...
Game.prototype.createImageGrid = function () {
    ...
    for (let i=0; i<this.imageCount; i++) {
        ...
        let nextImageIndex = Math.floor(Math.random() * (imagesLength - i));
        this.selectedImages[i] = new Image(i, this.images[nextImageIndex], parentDiv, "img"+i);

        let temp = this.images[nextImageIndex];
...
Game.prototype.setTargetImage = function () {
    let remainingMatches = this.selectedImages.length - this.matchedImageCount;
...
function startGame() {
    ...
    let decisionImgs = document.createElement("div");
